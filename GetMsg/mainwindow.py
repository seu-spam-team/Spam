...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.movetotrash = QtWidgets.QPushButton(MainWindow)
        self.movetotrash.setMinimumSize(QtCore.QSize(100, 28))
        self.movetotrash.setMaximumSize(QtCore.QSize(100, 28))
        self.movetotrash.setObjectName("movetotrash")
        self.horizontalLayout_5.addWidget(self.movetotrash, 0, QtCore.Qt.AlignRight)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.movetotrash.setText(_translate("MainWindow", "移至垃圾箱"))
